...
public:
    ...
    Customer(std::string name, std::string id, int bal, int number, std::string password)
    {
        this->name = name;
        this->id = id;
        this->balance = bal;
...
public:
    ...
    Vip(std::string name, std::string id, int bal, int number, std::string password, int discount) : Customer(name, id, bal, number, password)
    {
